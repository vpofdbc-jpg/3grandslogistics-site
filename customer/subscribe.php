                    ...
                    <div style="display: grid; grid-template-columns: 1fr; gap: 1rem;">
                        <label class="radio-label">
                            ...
                            <div class="label-content">
                                <span class="label-text">📦 On-Demand Delivery (Pay-as-You-Go)</span>
                                <p class="service-description">
                                    Perfect for occasional deliveries. Your fee is based on the package's weight & dimensions OR the mileage to your destination. You'll be charged the greater of the two.
                        ...
                        <label class="radio-label">
                            ...
                            <div class="label-content">
                                <span class="label-text">🔒 VWC Subscription Plan</span>
                                <p class="service-description">
                                    Enjoy unlimited VWC deliveries each month for <span class="font-semibold text-primary-dark">$23.99/month</span>. This plan includes:
                                    <ul class="list-disc list-inside text-xs text-gray-500 mt-2 ml-4">
                                        <li>Unlimited VWC deliveries</li>
                                    ...
                                    No additional fees for VWC deliveries—just one flat monthly rate! On-Demand deliveries are still priced per delivery.
                                </p>
                            </div>
                        </label>
                    </div>
